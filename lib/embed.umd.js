    ...
    ***************************************************************************** */
    ...
    function createEventListeners(iframe, options, type) {
        ...
        window.addEventListener("message", function (event) {
            var _a;
            console.log(1, iframe.contentWindow, event.source, iframe.contentWindow === event.source);
            if (iframe.contentWindow !== event.source)
                return;
            console.log(2, authorizedDomain, event.origin, authorizedDomain.indexOf(event.origin));
